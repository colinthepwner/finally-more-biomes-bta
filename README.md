...
"Biomes O' Plenty". It is called **Better O' Plenty** so that the two are not confused with each
other.
...
5. Start a new world and pick the **Better O' Plenty** world type.
...
the images and sounds out of it, writes a texture pack called `BetterOPlentyAssets`, and enables it
...
**Delete `texturepacks/BetterOPlentyAssets` to force a fresh look.**
...
<!-- keywords: biomes o plenty, BOP, BTA, Better than Adventure, babric, fabric, minecraft beta 1.7.3,
b1.7.3, halplibe, bta mod, bta 8.0.1, Glitchfiend, biome mod, worldgen -->
