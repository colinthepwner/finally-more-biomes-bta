...
public class WorldGenQuagmire extends BOPWorldFeature {

	private final int minableBlockId;

	private final int numberOfBlocks;

	public WorldGenQuagmire() {
		this(Blocks.GRASS.id(), 48);
	}
					...
					for (int var41 = var33; var41 <= var36; ++var41) {
						...
						if (var39 * var39 + var42 * var42 < 1.0D) {
							for (int var44 = var34; var44 <= var37; ++var44) {
								...
								if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && getBlockId(par1World, var38, var41, var44) == mudId) {
