...
public class WorldGenGravel extends BOPWorldFeature {
				...
				for (int var9 = par5 - var6; var9 <= par5 + var6; ++var9) {
					...
					if (var10 * var10 + var11 * var11 <= var6 * var6) {
						for (int var12 = par4 - var7; var12 <= par4 + var7; ++var12) {
							...
							if (var13 == Blocks.DIRT.id() || var13 == Blocks.GRASS.id() || var13 == Blocks.STONE.id()) {
								setBlock(par1World, var8, var12, var9, Blocks.GRAVEL.id());
							}
						}
					}
				}
