...
public class WorldGenQuicksand extends BOPWorldFeature {
					...
					for (int var41 = var33; var41 <= var36; ++var41) {
						...
						if (var39 * var39 + var42 * var42 < 1.0D) {
							for (int var44 = var34; var44 <= var37; ++var44) {
								...
								int id = getBlockId(par1World, var38, var41, var44);

								if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D
										&& (id == Blocks.GRASS.id() || id == Blocks.DIRT.id() || id == Blocks.SAND.id())) {
									setBlockAndMetadata(par1World, var38, var41, var44, minableBlockId, 0);
								}
							}
						}
					}
