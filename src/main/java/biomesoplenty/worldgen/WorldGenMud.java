...
public class WorldGenMud extends BOPWorldFeature {

	private final int mudId;

	private final int radius;

	public WorldGenMud(int radius, int mudId) {
		this.mudId = mudId;
		this.radius = radius;
	}
					...
					if (var10 * var10 + var11 * var11 <= var6 * var6) {
						for (int var12 = par4 - var7; var12 <= par4 + var7; ++var12) {
							...
							if (var13 == Blocks.DIRT.id() || var13 == Blocks.GRASS.id()) {
								setBlock(par1World, var8, var12, var9, this.mudId);
							}
						}
					}
				}
