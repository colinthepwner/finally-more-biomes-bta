...
public class WorldGenBog1 extends BOPWorldFeature {
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		for (var6 = par2Random.nextInt(5) + 7; getBlockMaterial(par1World, par3, par4 - 1, par5) == Materials.WATER; --par4) {
			;
		}
				...
				if (Blocks.hasTag(var8, BlockTags.GROWS_TREES) && par4 < worldHeight - var6 - 1) {
					...
					for (var16 = 0; var16 < var6; ++var16) {
						...
						if (isTrunkPath(par1World, par3, par4 + var16, par5, leavesId)
							|| getBlockId(par1World, par3, par4 + var16, par5) == waterMoving
							|| getBlockId(par1World, par3, par4 + var16, par5) == waterStill) {
							setBlock(par1World, par3, par4 + var16, par5, logId);
							setBlock(par1World, par3 - 1, par4 + var16, par5, logId);
							setBlock(par1World, par3 + 1, par4 + var16, par5, logId);
							setBlock(par1World, par3, par4 + var16, par5 - 1, logId);
							setBlock(par1World, par3, par4 + var16, par5 + 1, logId);
							setBlock(par1World, par3 - 1, par4, par5 - 1, logId);
							setBlock(par1World, par3 + 1, par4, par5 + 1, logId);
							setBlock(par1World, par3 - 1, par4, par5 + 1, logId);
							setBlock(par1World, par3 + 1, par4, par5 - 1, logId);
							setBlock(par1World, par3 - 1, par4 + 1, par5 - 1, logId);
							setBlock(par1World, par3 + 1, par4 + 1, par5 + 1, logId);
							setBlock(par1World, par3 - 1, par4 + 1, par5 + 1, logId);
							setBlock(par1World, par3 + 1, par4 + 1, par5 - 1, logId);

							setBlockAndMetadata(par1World, par3 - 2, par4, par5, logId, 4);
							setBlockAndMetadata(par1World, par3 + 2, par4, par5, logId, 4);
							setBlockAndMetadata(par1World, par3, par4, par5 - 2, logId, 8);
							setBlockAndMetadata(par1World, par3, par4, par5 + 2, logId, 8);
							setBlock(par1World, par3 - 1, par4 + (var6 - 4), par5 - 1, logId);
							setBlock(par1World, par3 + 1, par4 + (var6 - 4), par5 + 1, logId);
							setBlock(par1World, par3 - 1, par4 + (var6 - 4), par5 + 1, logId);
							setBlock(par1World, par3 + 1, par4 + (var6 - 4), par5 - 1, logId);
							setBlockAndMetadata(par1World, par3 - 2, par4 + (var6 - 4), par5, logId, 4);
							setBlockAndMetadata(par1World, par3 + 2, par4 + (var6 - 4), par5, logId, 4);
							setBlockAndMetadata(par1World, par3, par4 + (var6 - 4), par5 - 2, logId, 8);
							setBlockAndMetadata(par1World, par3, par4 + (var6 - 4), par5 + 2, logId, 8);
							setBlock(par1World, par3 - 3, par4 + (var6 - 3), par5, logId);
							setBlock(par1World, par3 + 3, par4 + (var6 - 3), par5, logId);
							setBlock(par1World, par3, par4 + (var6 - 3), par5 - 3, logId);
							setBlock(par1World, par3, par4 + (var6 - 3), par5 + 3, logId);
						}
					}
