...
public class WorldGenDeadTree extends BOPWorldFeature {
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
			...
			while (var13 <= var7) {
				...
				if (var15 > par4 * par4) {
					...
					int var14 = getBlockId(this.worldObj, var11[0], var11[1], var11[2]);

					if (var14 != 0 && !isLeaves(var14)) {
						++var13;
					} else {
						setBlockAndMetadata(this.worldObj, var11[0], var11[1], var11[2], par6, 0);
						++var13;
					}
				}
			}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3) {
		...
		if (var4[var6] != 0) {
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
				...
				setBlockAndMetadata(this.worldObj, var14[0], var14[1], var14[2], par3, var17);
			}
		}
	}

	private static final byte AXIS_Y = 0;

	private static final byte AXIS_X = 2;

	private static final byte AXIS_Z = 1;
	...
	void generateTrunk() {
		int logId = BOPWoodSets.DEAD.log.id();
		...
		this.placeBlockLine(var5, var6, logId);
	...
	void generateLeafNodeBases() {
		...
		for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1) {
			...
			if (this.leafNodeNeedsBase(var6)) {
				this.placeBlockLine(var3, var5, logId);
			}
		}
	}
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
		...
		if (var3[var5] == 0)
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
				...
				int var16 = getBlockId(this.worldObj, var13[0], var13[1], var13[2]);

				if (var16 != 0 && !isLeaves(var16)) {
					break;
				}
			}
	...
	boolean validTreeLocation() {
		...
		int var3 = getBlockId(this.worldObj, this.basePos[0], this.basePos[1] - 1, this.basePos[2]);

		if (!Blocks.hasTag(var3, BlockTags.GROWS_TREES) && var3 != Blocks.MUD.id())
			return false;
		else {
