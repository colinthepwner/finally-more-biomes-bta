...
public class WorldGenOvergrownTree extends BOPWorldFeature {
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		for (var6 = par2Random.nextInt(10) + 8; getBlockMaterial(par1World, par3, par4 - 1, par5) == Materials.WATER; --par4) {
			;
		}
			...
			if (!var7)
				...
				if (Blocks.hasTag(var8, BlockTags.GROWS_TREES) && par4 < worldHeight - var6 - 1) {
					...
					for (var16 = 0; var16 < var6; ++var16) {
						...
						if (var10 == 0 || var10 == leavesId || var10 == waterMoving || var10 == waterStill) {
	...
	private void generateVines(World par1World, int par2, int par3, int par4, int par5) {
		...
		setBlock(par1World, par2, par3, par4, leavesId);
		int var6 = 6;
