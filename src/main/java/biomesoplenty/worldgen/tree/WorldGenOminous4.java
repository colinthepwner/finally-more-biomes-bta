...
public class WorldGenOminous4 extends BOPWorldFeature {

	public WorldGenOminous4(boolean par1) {
	}
		...
		if (var4 >= 1 && var4 + var6 + 1 <= worldHeight) {
			...
			if (!var10)
				...
				if (Blocks.hasTag(var11, BlockTags.GROWS_TREES) && var4 < worldHeight - var6 - 1) {
					...
					if (Blocks.hasTag(var24, BlockTags.GROWS_TREES) && var4 < worldHeight - var6 - 1) {

						if ((Blocks.hasTag(var13, BlockTags.GROWS_TREES) || var24 == dirtId) && var4 < worldHeight - var6 - 1) {

							if ((Blocks.hasTag(var14, BlockTags.GROWS_TREES) || var24 == dirtId) && var4 < worldHeight - var6 - 1) {

								if (Blocks.hasTag(var25, BlockTags.GROWS_TREES) && var4 < worldHeight - var6 - 1) {
