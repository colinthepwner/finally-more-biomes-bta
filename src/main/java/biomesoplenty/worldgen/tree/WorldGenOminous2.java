...
public class WorldGenOminous2 extends BOPWorldFeature {
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		for (var6 = par2Random.nextInt(4) + 5; getBlockMaterial(par1World, par3, par4 - 1, par5) == Materials.WATER; --par4) {
			;
		}
	...
	private void generateVines(World par1World, int par2, int par3, int par4, int par5) {
		final int treeMossId = BOPPlants.TREE_MOSS.id();

		setBlockAndMetadata(par1World, par2, par3, par4, treeMossId, par5);
		int var6 = 4;
