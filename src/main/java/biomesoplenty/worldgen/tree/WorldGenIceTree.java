...
public class WorldGenIceTree extends BOPWorldFeature {
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		if (par4 >= 1 && par4 + var6 + 1 <= worldHeight) {
			...
			if (!var10)
				...
				if (var11 == Blocks.BLOCK_SNOW.id() && par4 < worldHeight - var6 - 1) {

					setBlock(par1World, par3, par4 - 1, par5, Blocks.BLOCK_SNOW.id());
						...
						for (var17 = par3 - var21; var17 <= par3 + var21; ++var17) {
							...
							for (int var19 = par5 - var21; var19 <= par5 + var21; ++var19) {
								...
								if ((Math.abs(var18) != var21 || Math.abs(var20) != var21 || var21 <= 0) && !isOpaqueCube(par1World, var17, var16, var19)) {
									setBlock(par1World, var17, var16, var19, iceId);
								}
							}
						}
					...
					for (var16 = 0; var16 < var6 - var15; ++var16) {
						if (isTrunkPath(par1World, par3, par4 + var16, par5, iceId)) {
							setBlock(par1World, par3, par4 + var16, par5, iceId);
						}
					}
