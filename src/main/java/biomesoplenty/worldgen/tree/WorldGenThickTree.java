...
public class WorldGenThickTree extends BOPWorldFeature {
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if (var4 >= 1 && var4 + var6 + 1 <= worldHeight) {
			...
			if (!var10)
				...
				var14 = getBlockId(var1, var3 - 1, var4 - 1, var5 - 1);

				if (Blocks.hasTag(var11, BlockTags.GROWS_TREES)
						&& Blocks.hasTag(var24, BlockTags.GROWS_TREES)
						&& Blocks.hasTag(var13, BlockTags.GROWS_TREES)
						&& Blocks.hasTag(var14, BlockTags.GROWS_TREES)
						&& var4 < worldHeight - var6 - 1) {

					onTreeGrownAt(var1, var3, var4, var5);
					onTreeGrownAt(var1, var3 - 1, var4, var5);
					onTreeGrownAt(var1, var3, var4, var5 - 1);
					onTreeGrownAt(var1, var3 - 1, var4, var5 - 1);
					...
					for (var18 = 0; var18 <= var8; ++var18) {
						...
						for (var20 = var3 - var15; var20 <= var3 + var15; ++var20) {
							...
							for (int var22 = var5 - var15; var22 <= var5 + var15; ++var22) {
								...
								if ((Math.abs(var21) != var15 || Math.abs(var23) != var15 || var15 <= 0) && !isOpaqueCube(var1, var20, var19, var22)) {
									...
									setBlock(var1, var20 - 1, var19, var22 - 1, leavesId);
								}
							}
						}
					...
					for (var19 = 0; var19 < var6 - var18; ++var19) {
						if (isTrunkPath(var1, var3, var4 + var19, var5, leavesId)) {
							...
							setBlock(var1, var3 - 1, var4 + var19, var5 - 1, logId);
						}
					}
