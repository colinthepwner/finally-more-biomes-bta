...
public class WorldGenGiantFlowerRed extends BOPWorldFeature {
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		final int petal = BOPBlocks.BIG_FLOWER_RED.id();
		...
		setBlock(var1, var3 + 1, var4 + 7, var5 + 1, petal);
		setBlock(var1, var3 + 1, var4 + 7, var5 - 1, petal);
		setBlock(var1, var3 - 1, var4 + 7, var5 + 1, petal);
		setBlock(var1, var3 - 1, var4 + 7, var5 - 1, petal);
		setBlock(var1, var3 + 2, var4 + 7, var5, petal);
		setBlock(var1, var3 - 2, var4 + 7, var5, petal);
		setBlock(var1, var3, var4 + 7, var5 + 2, petal);
		setBlock(var1, var3, var4 + 7, var5 - 2, petal);
		setBlock(var1, var3 + 2, var4 + 7, var5 + 2, petal);
		setBlock(var1, var3 + 2, var4 + 7, var5 - 2, petal);
		setBlock(var1, var3 - 2, var4 + 7, var5 + 2, petal);
		setBlock(var1, var3 - 2, var4 + 7, var5 - 2, petal);

		setBlock(var1, var3 + 2, var4 + 8, var5, petal);
		setBlock(var1, var3 - 2, var4 + 8, var5, petal);
		setBlock(var1, var3, var4 + 8, var5 + 2, petal);
		setBlock(var1, var3, var4 + 8, var5 - 2, petal);

		setBlock(var1, var3 + 3, var4 + 9, var5, petal);
		setBlock(var1, var3 - 3, var4 + 9, var5, petal);
		setBlock(var1, var3, var4 + 9, var5 + 3, petal);
		setBlock(var1, var3, var4 + 9, var5 - 3, petal);
