...
public class WorldGenCanyonShrub extends BOPWorldFeature {

	private static final int MIN_Y = 2 * 86;

	private static final int MAX_Y = 2 * 96;
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		if (var7 == BOPBlocks.HARD_DIRT.id()) {
			++par4;
			if (par4 < MAX_Y && par4 > MIN_Y) {
				setBlockAndMetadata(par1World, par3, par4, par5, BOPWoodSets.ACACIA.log.id(), 0);
