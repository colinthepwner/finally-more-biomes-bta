...
public class BiomeGenPromisedLandPlains extends BiomeGenBase {
	...
	public BiomeGenPromisedLandPlains(String key) {
		super(key);
	...
	@NotNull
	@Override
	public net.minecraft.core.world.generate.feature.WorldFeature getTreeFeature(@NotNull java.util.Random random) {
		return new biomesoplenty.worldgen.tree.WorldGenPromisedTree(false);
	}
