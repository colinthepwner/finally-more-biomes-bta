...
public class BiomeGenSeasonalSpruceForest extends BiomeGenBase {
	...
	public static final int MAP_COLOR = 10067517;

	public BiomeGenSeasonalSpruceForest(String key) {
		super(key);
		...
		this.setMinMaxHeight(0.6f, 0.9f);
	...
	public WorldFeature getTreeFeature(@NotNull Random random) {
		...
		if (random.nextInt(2) == 0) return new WorldGenTaiga5(false);
		if (random.nextInt(4) == 0) return new WorldGenTaiga10(false);
